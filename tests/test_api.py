...
def test_unregister_removes_participant():
    # Arrange
    activity_name = "Chess Club"
    email = "temporary-participant@mergington.edu"
...
def test_unknown_activity_returns_not_found(method, path):
    # Arrange
...
def test_unregistering_unknown_participant_returns_bad_request():
    # Arrange
    activity_name = "Chess Club"
...
def test_missing_email_returns_validation_error(method):
    # Arrange
    request = getattr(client, method)

    # Act
    response = request("/activities/Chess Club/signup")
...
def test_activity_name_with_spaces_is_supported():
    ...
    email = "new-programmer@mergington.edu"
